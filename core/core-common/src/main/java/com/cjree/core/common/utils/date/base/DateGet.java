package com.cjree.core.common.utils.date.base;


import com.cjree.core.common.utils.date.enums.DateStyle;
import com.cjree.core.common.utils.date.enums.Week;
...
public abstract class DateGet extends DateConvert{
    ...
    /**
     * 获取本年最后一天
     * @author wxy 2022/5/9 19:16
     */
    public static Date getLastDayByCurrentYear(){
        Calendar calendar = Calendar.getInstance();
        calendar.clear();
