package com.cjree.core.cloud.seata;
...
@Component
@Order(value = 1)
public class SeataDDL implements ApplicationRunner {

    private static final Logger log = LoggerFactory.getLogger(SeataDDL.class);
    ...
    // TODO seata2.1之后在多数据源自动代理时会检查undolog表是否存在，此时以下脚本还未执行，所以先手动建表undolog
