...
public class FTPClientPool implements ObjectPool<FTPClient> {
	...
	public static void main(String[] args) throws Exception {
		...
		// 连接代理服务器
		ftpClientConfigure.setHost("127.0.0.1");
		ftpClientConfigure.setUsername("ftpuser1");
		ftpClientConfigure.setClientTimeout(2000000000);
		ftpClientConfigure.setPort(21);
		ftpClientConfigure.setEncoding("UTF-8");
		ftpClientConfigure.setPassword("ftp");
